...
CREATE TABLE `cards` (
  ...
  `questions` varchar(1500) collate utf8_unicode_ci default NULL,
  PRIMARY KEY  (`cardID`)
...
INSERT INTO `exammarks` VALUES (5,1,23,2,4,4,4,0,0,4),(6,1,24,2,1,1,1,1.77952e+009,2.25194e+006,0),(7,1,26,2,2,3,3,0,0,5),(8,1,28,2,5,5,5,0,0,5),(9,1,30,2,4,4,4,3,3,4),(10,2,32,2,4,4,4,0,0,4),(11,2,34,2,5,5,5,0,0,0),(12,1,34,2,5,5,5,5,5,5),(13,2,35,2,4,5,4,0,0,4),(14,1,35,2,4,4,4,4,3,4),(15,1,36,2,4,4,4,3,3,4),(16,2,36,2,4,4,4,0,0,4),(17,2,37,2,4,4,4,0,0,4),(18,1,37,2,5,4,4,4,4,4),(19,1,27,2,2,1,2,1.77952e+009,2.27231e+006,2);
...
CREATE TABLE `examstudentlist` (
  ...
  `answersCharacteristic` varchar(500) collate utf8_unicode_ci default NULL,
  `specialOpinions` varchar(500) collate utf8_unicode_ci default NULL,
  ...
  KEY `cardIDForStudentList` (`cardID`),
  CONSTRAINT `cardIDForStudentList` FOREIGN KEY (`cardID`) REFERENCES `cards` (`cardID`) ON UPDATE CASCADE,
...
INSERT INTO `examstudentlist` VALUES (2,21,20,NULL,NULL,NULL,NULL),(2,22,10,NULL,NULL,NULL,NULL),(2,23,39,NULL,NULL,NULL,NULL),(2,24,1,NULL,NULL,NULL,NULL),(2,25,29,NULL,NULL,NULL,NULL),(2,26,36,NULL,NULL,NULL,NULL),(2,27,17,NULL,NULL,NULL,NULL),(2,28,44,NULL,NULL,NULL,NULL),(2,29,11,NULL,NULL,NULL,NULL),(2,30,41,NULL,NULL,NULL,NULL),(2,31,2,NULL,NULL,NULL,NULL),(2,32,40,NULL,NULL,NULL,NULL),(2,33,8,NULL,NULL,NULL,NULL),(2,34,3,NULL,NULL,NULL,NULL),(2,35,38,NULL,NULL,NULL,NULL),(2,36,43,NULL,NULL,NULL,NULL),(2,37,42,NULL,NULL,NULL,NULL);
...
CREATE TABLE `groups` (
  ...
  `groupName` varchar(7) collate utf8_unicode_ci NOT NULL,
...
INSERT INTO `groups` VALUES (1,'1ПО-52',2008),(2,'1ПО-51',2008);
...
CREATE TABLE `sacmembers` (
  ...
  `business` varchar(400) collate utf8_unicode_ci default NULL,
...
INSERT INTO `sacmembers` VALUES (1,'Селяничев1','Олег1','Леонидович1','1',NULL),(2,'Селяничев2','Олег2','Леонидович2','СОЛ2',NULL),(3,'4','4','4','4',NULL),(4,'5','5','5','5',NULL);
...
CREATE TABLE `themes` (
  ...
  `theme` varchar(1000) collate utf8_unicode_ci NOT NULL,
  `studentID` int(10) unsigned NOT NULL,
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `saveUser`(
...
BEGIN
  ...
  IF EXISTS (SELECT * FROM users WHERE username = newname) THEN



    UPDATE users SET userpassword = newpassword WHERE username = newname;
  ...
  ELSE
    ...
    INSERT INTO users (username, userpassword) VALUES (newname, newpassword);
...
BEGIN
UPDATE examstudentlist SET cardID=(
	SELECT cardID FROM cards WHERE cardNumber=cardNum LIMIT 1
	) WHERE examID=exam AND studentID=student;
END */;;
/*!50003 SET SESSION SQL_MODE=@OLD_SQL_MODE*/;;
...
-- Dump completed on 2009-05-10 20:16:34
