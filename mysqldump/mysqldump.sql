...
CREATE TABLE `examstudentlist` (
  ...
  KEY `cardIDForStudentList` USING BTREE (`cardNumber`),
...
INSERT INTO `examstudentlist` VALUES (2,23,12,NULL,NULL,NULL,NULL),(2,24,13,NULL,NULL,NULL,NULL);
...
INSERT INTO `sacmembers` VALUES (1,'Селяничев1','Олег1','Леонидович1','1','test'),(2,'Селяничев2','Олег2','Леонидович2','СОЛ2',NULL),(3,'4','4','4','4',NULL),(4,'5','5','5','5',NULL);
...
INSERT INTO `studentmarks` VALUES (24,1,5),(24,2,3),(24,3,4);
...
INSERT INTO `subjects` VALUES (1,'Физика'),(2,'Информатика'),(3,'Алгебра и геометрия');
...
-- Dump completed on 2009-05-24 10:04:36
