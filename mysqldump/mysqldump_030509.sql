...
CREATE TABLE `exams` (
  ...
  CONSTRAINT `secrIDForExams` FOREIGN KEY (`secretaryID`) REFERENCES `sacmembers` (`memberID`) ON UPDATE CASCADE,
...
INSERT INTO `examstudentlist` VALUES (2,21,20,NULL),(2,22,10,NULL),(2,23,39,NULL),(2,24,1,NULL),(2,25,29,NULL),(2,26,36,NULL),(2,27,17,NULL),(2,28,44,NULL),(2,29,11,NULL),(2,30,41,NULL),(2,31,2,NULL),(2,32,40,NULL),(2,33,8,NULL),(2,34,3,NULL),(2,35,38,NULL),(2,36,43,NULL),(2,37,42,NULL);
...
CREATE TABLE `sacmembers` (
  ...
  KEY `userIDForSACMembers` (`userID`),
  CONSTRAINT `userIDForSACMembers` FOREIGN KEY (`userID`) REFERENCES `users` (`userID`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `sacmembers` VALUES (1,'Селяничев1','Олег1','Леонидович1','1',1),(2,'Селяничев2','Олег2','Леонидович2','СОЛ2',2),(3,'4','4','4','4',3),(4,'5','5','5','5',4);
...
INSERT INTO `users` VALUES (1,'test','test'),(2,'test2','test2'),(3,'test4','test4'),(4,'test5','test5');
...
-- Dump completed on 2009-05-03  9:02:07
